...
Locale.Register('en', {
    error = {
        on_duty = 'Go off duty first.', not_held = 'You do not hold that job.', not_allowed = 'Your trade does not bill.', bad_amount = 'Not that amount.', cannot_pay = 'It cannot be paid now.', too_far = 'Get closer.',
    ...
    info = { you_fired = 'You no longer work for %{job}.', no_jobs = 'You hold no job.', switched = 'You are on that job now.', left = 'You left the job.',
        you_paid = 'You paid $%{amount} to %{job}: %{reason}', you_owe = 'You owe $%{amount} to %{job} — a receipt is in your satchel; use it to pay.', bill_paid = 'They paid.', bill_receipt = 'They could not pay now; they hold a receipt.', receipt_paid = 'Receipt settled: $%{amount} to %{job}.' },
    command = { myjobs = 'The jobs you hold — switch or leave one' },
    ui = {
        my_jobs = 'The jobs you hold', jobs_cap = '%{n} of %{cap}', active = 'active', switch_to = 'Take up this job', leave_job = 'Leave this job', person = 'Person', bill = 'Bill', bill_amount = 'Dollars', bill_reason = 'For what',
